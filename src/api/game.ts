...
import type {
  ...
  BattleSummaryResponse, QuestResponse, CharacterQuestResponse, Category,
...
export const categoryApi = {
  getCategorisInfo: (characterId: string) =>
    gameApi.get<Category[]>(`/api/v1/category/${characterId}`).then(r => r.data),
}
